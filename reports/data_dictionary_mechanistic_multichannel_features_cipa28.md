...
Source priority:
1. Crumb 2016 text extraction (block curves fit to IC50).
2. Crumb2016 PDF-derived block curves fit to IC50 (legacy parser).
3. ChEMBL strict IC50 '=' (µM-convertible).
4. ChEMBL relaxed IC50 (non '=' relations) if strict absent.
5. CiPA GitHub IC50 (only if any IC50 rows are present).
6. Missing if no comparable IC50.
...
- source_hERG: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
...
- source_Nav1.5_peak: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
...
- source_Nav1.5_late: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
...
- source_Cav1.2: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
...
- source_IKs: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
...
- source_IK1: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
...
- source_Kv4.3: data source used (crumb_text, crumb2016, chembl_strict, chembl_relaxed, cipa_repo, missing).
